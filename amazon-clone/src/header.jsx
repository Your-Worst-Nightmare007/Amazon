            ...
            <div className="header-nav">
                <Link to='/login'>
                    <div className="header-options">
                        <span className='optionfirst'>
                            Hello Yash
                        </span>
                        <span className='optionsecond'>
                            Sign-in
                        </span>
                    </div>
                </Link>
                ...
                <Link to="/checkout">
                    <div className='header-option-basket'>
                        <ShoppingBasketIcon />
                        <span className="optionsecond cartCount">
                            {basket?.length}
                        </span>
                    </div>
                </Link>
